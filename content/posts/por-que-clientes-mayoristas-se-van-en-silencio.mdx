...
<StatGrid cols={3}>
  ...
  <StatCard value="$4.8M" label="LTV no capturado" detail="X meses proyectados por cliente" />
</StatGrid>
...
**Sobre el Autor:**
Patricio Guillermo Galván es Encargado del Canal Mayorista de IEY® (150+ clientes B2B) y fundador de PymePilot. Documenta públicamente sus procesos y aprendizajes.
